    ...
    return (
        <>
            ...
            <Grid container spacing={5} style={{ margin: 0, width: "100%" }}>
                ...
                <Grid item>
                    <AboutStaffVerticalRight uname="AlexTheSavage07" quote="Graphic Designer & Developer" uuid="3142a128-d6e7-40f2-97e0-417e3d6bbff0" github="asavage7" youtube="UCbEnlral5D80rJr8k8xrHuQ" discord="Asavage7#3718" twitter="alexthesavage07" twitch="g3mlive" reddit="AlexTheSavage07" />
                </Grid>
                <Grid item>
