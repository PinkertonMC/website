...
export default function ClassicPage(): JSX.Element {
    document.title = "Classic | PinkertonMC";
    return (
        <div className="text-center s3-body">
            <Card color="primary" style={{ marginBottom: "2rem" }} className="head">
                <img src="/assets/images/pinkertonclassic.png" className="logos" alt="Pinkerton Classic logo" />
                <h1 className="s3-heading">
                    <div className="marki markianimation">Pinkerton's Classic SMP</div>
                </h1>
                <h3>
                    Enjoy Vanilla survial, the Pinkerton way.
                </h3>
            </Card>
            <div className="main">
                <div className="box">
                    <div className="textheader cssanimation fadeInBottom" style={{ marginBottom: "2rem" }}>
                        <h2>Why should you join PinkertonMC Classic?</h2>
                        <p>Pinkerton Classic is just like every other survival SMP, while not being the same.</p>
                        <hr />
                    </div>
                </div>
