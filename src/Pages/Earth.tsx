...
export default function EarthPage(): JSX.Element {
    ...
    return (
        <div className="text-center s3-body" style={{ backgroundColor: "black" }}>
            <Card color="primary" style={{ marginBottom: "2rem" }} className="head">
                <img src="/assets/images/pinkertons3website.png" className="logos" alt="Pinkerton Earth logo" />
                <h1 className="s3-heading">
                    <div className="marki markianimation">Truly a Minecraft Experience like No Other</div>
                </h1>
                <h3>
                    A brand-new Minecraft experience.
                </h3>
            </Card>
            <div className="main">
                <div className="box">
                ...
                <div className="box cssanimation fadeInBottom">
                    ...
                    <Stepper activeStep={-1} alternativeLabel>
                        ...
                        <Step>
                            <StepLabel>Go through the Earth Portal in the lobby or type <code>/earth</code>.</StepLabel>
                        </Step>
                        <Step>
