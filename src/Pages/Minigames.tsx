...
export default function MinigamesPages(): JSX.Element {
    document.title = "Minigames | PinkertonMC";
    return (
        <div className="text-center s3-body">
            <Card color="primary" style={{ marginBottom: "2rem" }} className="head">
                ...
                <h3>With custom items, better terrain, more biomes, player shops, and more, Pinkerton Minigames is the Minecraft Server of choice for anyone and everyone.
                </h3>
            </Card>
            <div className="main">
                <div className="box">
                    <div className="textheader cssanimation fadeInBottom" style={{ marginBottom: "2rem" }}>
                        <h2>Why should you join Pinkerton Minigames?</h2>
                ...
                <div className="box cssanimation fadeInBottom">
                    ...
                    <Stepper activeStep={-1} alternativeLabel>
                        ...
                        <Step>
                            <StepLabel>Go through the S3 Portal in the lobby or type <code>/minigames</code>.</StepLabel>
                        </Step>
                        <Step>
