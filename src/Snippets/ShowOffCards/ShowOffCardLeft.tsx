...
export default function ShowOffCardLeft(props: { buttonText: string, buttonStartIcon: JSX.Element, buttonClickLink: string, cardContent: JSX.Element | string, cardContentDescription: string, text: JSX.Element | string, textHeading: JSX.Element | String }): JSX.Element {
    return (
        <div className="box">
