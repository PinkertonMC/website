...
export default function ShowOffCardLeft(props: { buttonText: string, buttonStartIcon: JSX.Element, buttonClickLink: string, cardContent: JSX.Element | string, cardContentDescription: string, text: JSX.Element | string, textHeading: JSX.Element | String, routerLink?: boolean }): JSX.Element {
    return (
        <div className="box">
                ...
                <Grid item sm={6} style={{ width: "100%" }} className="discordboxiframe">
                    <div style={{ paddingTop: "7%", paddingLeft: "3.5%" }}>
                        <div className="outerboxleft cssanimation fadeInBottom" style={{ width: "100%" }}>
                            {typeof props.cardContent == "string" ? <img className="innerboxleft scaleimg" src={(props.cardContent) as string} alt={props.cardContentDescription} /> : props.cardContent}
                        </div>
                    </div>
                </Grid>
                <Grid item sm={6} style={{ display: "flex", alignItems: "center" }} className="discordtext">
                    <div>
                        <div className="textarearight cssanimation fadeInBottom" style={{ width: "100%" }}>
